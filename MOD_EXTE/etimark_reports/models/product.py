...
class ProductProduct(models.Model):
    ...
    measures_in_cm = fields.Char(string="Medidas en cm")
    raw_material = fields.Char(string="Materia Prima")
    mile_price_usd = fields.Float(string="Precio por Milla", related='product_tmpl_id.mile_price_usd', digits=(12,2), store=False)
    mile_price = fields.Float(string="Precio por Milla Bs.", related='product_tmpl_id.mile_price', digits=(12,2), store=False)
