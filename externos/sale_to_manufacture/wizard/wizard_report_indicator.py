    ...
    def averag_shrinkage(self):
        if self.report == 'AS':
                ...
                if w.show_report == True:
                    ...
                    for i in average_shrinkage:
                        if i.machine_name_id.id == w.id:
                            ...
                            Mt2_theoretical = (total_number_approved_labels * Mt2_produced) / number_labels_produced_coil
                            number_labels_rejected += i.number_labels_rejected
            ...
            for workcenter in workcenter_machine:
                ...
                ws.write(row, 4, workcenter["Mt2_theoretical"], body_style)
                ...
                ws.write(row, 9, workcenter["desp"], body_style)
            ...
            ws.write(row + 2, 3, format((total_total_number_approved_labels / total_number_labels_produced_coil) * 100, '.2f'), body_style)
            ws.write(row + 2, 5, format((total_number_labels_rejected / total_number_labels_produced_coil) * 100, '.2f'), body_style)
